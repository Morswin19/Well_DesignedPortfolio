    ...
    return (
      <div className={this.props.className}>
        ...
        <ul>
          <li>
            <a href='#header'>
              <span onClick={this.props.click}>Home</span>
            </a>
            <div className='sideLine'></div>
          </li>
          <li>
            <a href='#aboutMe'>
              <span onClick={this.props.click}>About Me</span>
            </a>
            <div className='sideLine'></div>
          </li>
          <li>
            <a href='#skillsTitles'>
              <span onClick={this.props.click}>Skills</span>
            </a>
            <div className='sideLine'></div>
          </li>
          <li id='projectsLink'>
            ...
            <a href='#projects'>
              <span onClick={this.props.click}>Projects</span>
            </a>
            {!this.state.projectActive ? (
              ...
              <>
                ...
                <ul id='projectSidebarList'>
                  ...
                  <li onClick={this.props.click}>
                    <a href='#My Music'>My Albums</a>
                    <div className='sideLine2'></div>
                  </li>
                  <li onClick={this.props.click}>
                    <a href='#PK Festival'>PK Festival</a>
                    <div className='sideLine2'></div>
                  </li>
                  <li onClick={this.props.click}>
          ...
          <li>
            <a href='#footer'>
              <span onClick={this.props.click}>Contact</span>
            </a>
            <div className='sideLine'></div>
          </li>
          <li onClick={this.props.click}>
