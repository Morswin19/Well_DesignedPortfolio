    ...
    <div id='aboutMe'>
      <div id='amInfo'>
        ...
        <p>
          ...
          this short introduction. I want to write code for you, but this is not
          the only good thing I can give. This is what you need to know about
          me:
        </p>
        <ul id='aboutList'>
          <li>
        ...
        <div id='experience'>
          ...
          <ul id='experienceList'>
            ...
            <li>
              <span></span>
              <p>
                writing this website taught me how to work fast and focus on the
                results.
              </p>
            </li>
          </ul>
